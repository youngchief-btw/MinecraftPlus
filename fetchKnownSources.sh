# rm -rf src/;
mkdir -p src/pkg/;
wget https://plus.minecraft.net/ -O src/index.html;
wget https://plus.minecraft.net/box.jpg -O src/box.jpg;
wget https://plus.minecraft.net/glowsquid.gif -O src/glowsquid.gif;
